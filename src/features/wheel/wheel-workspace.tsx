...
import type { ScoreTriple, WheelCycle, WheelKind, WheelSlug, WheelSpoke } from "./types";
    ...
    <div>
      ...
      {emptyBusiness ? (
        <p className="mb-4 max-w-prose text-sm text-muted-foreground">
          Your business wheel has no spokes yet. Name the functions you run, and rate each one.
        </p>
      ) : (
      ...
      {kind === "WOB" ? <SpokeManager wheelId={wheelId} spokes={allSpokes} /> : null}
    </div>
  );
}
